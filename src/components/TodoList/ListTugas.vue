<template>
    <v-main class="list">
        ...
        <v-dialog v-model="dialogdetail" persistent max-width="600px">
            <v-card>
                ...
                <v-card v-if="detail.priority == 'Penting'" outlined>
                    <v-chip
                    style="border-color: lightcoral; color: lightcoral; width: fit-content;"
                    >
                    Penting
                    </v-chip>
                </v-card>
                <v-card v-else-if="detail.priority == 'Biasa'" outlined>
                    <v-chip
                    style="border-color: lightblue; color: lightblue; width: fit-content;"
                    >
                    Biasa
                    </v-chip>
                </v-card>
                <v-card v-else outlined>
                    <v-chip
                    style="border-color: lightgreen; color: lightgreen; width: fit-content;"
                    >
                    Tidak Penting
                    </v-chip>
                </v-card>
        ...
        <v-card v-if="selectedItem.length">
            ...
            <v-btn color="red darken-1" @click="hapusSemua">
                Hapus Semua
            </v-btn>
        </v-card>
